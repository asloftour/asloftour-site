...
export default async function BookingPage({ params }: { params: Promise<{ locale: AppLocale }> }) {
      ...
      <Container className="py-16">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_400px]">
          ...
          <div className="space-y-6">
            <Card>
              <CardContent>
                <h2 className="text-xl font-semibold text-white">{tLocale(ui.booking.nextTitle, locale)}</h2>
                <p className="mt-4 text-sm leading-7 text-white/68">{tLocale(ui.booking.nextText, locale)}</p>
              </CardContent>
            </Card>
